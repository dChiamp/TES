$(document).ready(function() { 
	...
	function addDataEl (card, dataAttr){
		card.attr('data-card', dataAttr);
	}
	...
	$select.on("click", function() {
		var cardTest = 'card' + this.children[0].dataset.card;
		// var cardTest2 = 'card' + this

		console.log('THIS IS MY OBJECT', cards[cardTest]);
		console.log(cards[shape]);
